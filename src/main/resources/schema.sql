...
(
    ...
    "FILMID"  INT REFERENCES LIKES (FILMID) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS "EVENT_REVIEW"
(
    "EVENTID"   INT REFERENCES EVENTS (EVENTID) ON DELETE CASCADE ON UPDATE CASCADE,
    "REVIEWID"  INT REFERENCES REVIEWS (REVIEWID) ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS "EVENT_FRIEND"
(
    "EVENTID"   INT REFERENCES EVENTS (EVENTID) ON DELETE CASCADE ON UPDATE CASCADE,
    "FRIENDID"  INT REFERENCES FRIENDS (FRIENDID) ON DELETE CASCADE ON UPDATE CASCADE
);
