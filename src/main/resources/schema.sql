...
ALTER TABLE "FILMS_DIRECTORS"
    ADD CONSTRAINT "FK_FILMS_DIRECTORS_FILMID" FOREIGN KEY ("FILMID")
        REFERENCES "FILMS" ("FILMID") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "EVENTS"
    ADD CONSTRAINT "FK_EVENTS_EVENTTYPEID" FOREIGN KEY ("EVENTTYPEID")
        REFERENCES "EVENTTYPES" ("EVENTTYPEID") ON DELETE CASCADE ON UPDATE CASCADE;
